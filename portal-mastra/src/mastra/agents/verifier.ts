...
DESCRIPTION: If it reads like meta/SEO spam, rewrite 2–3 friendly discovery sentences using ONLY facts already in the description field. Do not add facts not present in the draft.
